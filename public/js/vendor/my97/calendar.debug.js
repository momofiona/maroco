...
My97DP.prototype = {
    ...
    _f: function(p, max, c, r, e, isR) {
        ...
        if (isR) $dt.attr("M", 1);
        bak = $dt[p];
        s.a("<table cellspacing=0 cellpadding=5 border=0>");
        for (var i = 0; i < r; i++) {
    ...
    _fy: function(_, B, A) {
        ...
        $.a("<table cellspacing=0 cellpadding=5 border=0 align=center><tr><td ");
        ...
        $.a(">\u2190</td><td class='menu' style='font-family:verdana;font-size:15px;' onmouseover=\"this.className='menuOn'\" onmouseout=\"this.className='menu'\" onmousedown=\"hide($d.yD);$d.yI.blur();\">\xd7</td><td ");
    ...
    _fillQS: function(C, A) {
        ...
        _.a("<tr class=MTitle><td><div style=\"float:left;padding-left:5px;\">" + $ + "</div>");
        if (!C) _.a("<div style=\"float:right;cursor:pointer;font-family: verdana;\" onclick=\"hide($d.qsDivSel);\">&nbsp;X&nbsp;</div>");
        _.a("</td></tr>");
