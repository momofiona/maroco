...
//扩展jqueryui dialog
jQuery.ui.dialog.prototype.lock=function(){
	if(this.locker==undefined){
		this.locker=jQuery('<span>',{'class':'dialog-lock'}).prependTo(this.uiDialog);
	}
	this.locker.show();
}
jQuery.ui.dialog.prototype.unlock=function(){
